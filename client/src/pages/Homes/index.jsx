...
function Homes() {
    ...
    const fetchHomes = useCallback(async (filters = {}, newPage = 1) => {
        setIsLoading(true);
        try {
            const response = await axios.get("/api/homes/all", {
                params: { ...filters, page: newPage, limit: 6 },
            });
    ...
    // Save scroll position in sessionStorage when loading more homes
    useEffect(() => {
        const handleScroll = () => {
