    ...
    return (
        <footer className="bg-black mt-16">
            <div className="mx-auto w-full max-w-screen-xl p-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="/" className="flex items-center">
                            <span className="font-sans self-center text-3xl font-extrabold whitespace-nowrap text-white">
                                NOMADSHELL
                            </span>
                        </a>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between text-gray-400">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <a
                            ...
                            className="hover hover:text-white ms-5"
                        >
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
